...
const Home = () => {
  ...
  return (
    <>
      ...
      <div className={styles.mobileHeaderClass}>
      ...
      <div className={styles.playerClass}>
        <iframe frameborder="no" scrolling="no" seamless="" src="https://player.simplecast.com/3efcc19a-e279-40af-9726-47a519956c3f?dark=true&amp;show=true&amp;color=000000"></iframe>
      </div>
